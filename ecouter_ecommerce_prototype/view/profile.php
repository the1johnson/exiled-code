...
$userBo->setEmail(UsersDAO::checkEmail($username));
$email = $userBo->getEmail();

$userBo->setIsAdmin(UsersDAO::checkAdmin($username));
$isAdmin = $userBo->getIsAdmin();
...
<div id='cartcontent'>
<p class='righttitlereg'>My Profile</p>
<p class='righttitlereg'>Uname <input name='userName' type='text' value = $username ></p>
<p class='righttitlereg'>Fname <input name='fname' type='text' value = $fName ></p>
<p class='righttitlereg'>Lname <input name='lname' type='text' value = $lName ></p>
<p class='righttitlereg'>Email <input name='email' type='text' value = $email ></p>
";
	if (!$isAdmin){
		echo "";
	} else {
		echo "<p class='righttitlereg'><a href='admin.php'>Admin</a></p>";
	}
echo "	
<br/>
