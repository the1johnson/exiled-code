...
<div class='wrapper'>
  <div id='header'>
      <div id='logo'>
       <a href='../index.php' title='�couter.com - Home' ><div id='home-link'><span>Home</span></div></a>  
      </div>
...
<div id='leftcolumn'>
<p class='categories'>Already a member?</p>
<br/>
<p class='categories'>Sign In</p>
<br/>

<form name='login' action='../service/login_call.php' method='post'>
Username: <input name='userName' id='logUser' type='text' />
<br/><br/>
Password: <input name='password' id='logPass' type='password' />
<br/><br/><br/>
...
<div id='rightcolumnreg'>
<p class='righttitlereg'>New to &#201;couter.com?</p>
<br/>
<p class='righttitlereg'>Sign Up</p>

<form name='register' action='../service/register_call.php' method='post'>
Username: <input name='userName' type='text' id='regUser' />
<br/><br/>
Email Address: <input name='email' type='text' id='email' />
<br/><br/>
First Name: <input name='fname' type='text' id='fname' />
<br/><br/>
Last Name: <input name='lname' type='text' id='lname' />
<br/><br/>
Password: <input name='password' type='password' id='regPass' />
<br/><br/>
<p class='categories'>Billing Info</p>
<p class='categories'>Shipping Info</p>
<br/>
<input type='submit' value='Register' />
</form>

<script type='text/javascript'>
	var regUser = new LiveValidation('regUser');
	regUser.add(Validate.Presence);
	var logUser = new LiveValidation('logUser');
	logUser.add(Validate.Presence);
	...
	var regPass = new LiveValidation('regPass');
	regPass.add(Validate.Presence);
	regPass.add(Validate.Length, {minimum: 6});
	var logPass = new LiveValidation('logPass');
	logPass.add(Validate.Presence);
	logPass.add(Validate.Length, {minimum: 6});
</script>
</div>
		  </div>	 
