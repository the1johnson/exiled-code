...
<div id='leftcolumn'>
      ...
      <div id='rightcolumn'>
        <p class='righttitle'>Category View &gt; Brand - Model</p>
          ...
          Rating<br/>
          <br/><br/>
          <form class='cart_form' action='../service/cart_action.php' method='get'>
          <input type='hidden' name='orderCode' value='$itemId$itemType' />
          <input type='hidden' name='orderType' value='$itemType' />
          <label>Item: <input type='text' name='quantity' value='1' size='3' /></label>
